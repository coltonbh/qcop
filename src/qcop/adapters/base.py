...
class BaseAdapter(ABC, Generic[SpecType, DataType]):
    ...
    def compute(
        ...
        **adapter_kwargs,
        ...
        Args:
            input_data: A qcio input object for a computation. E.g. A FileInput,
        ...
        with tmpdir(self.uses_files, scratch_dir, rm_scratch_dir) as final_scratch_dir:
            ...
            program_version = results.extras.get("program_version")
            ...
            output_obj = Results[SpecType, DataType](**output_dict)
